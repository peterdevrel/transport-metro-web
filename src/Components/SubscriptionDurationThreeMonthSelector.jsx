...
const SubscriptionDurationThreeMonthSelector = ({
  ...
  const handleSelect = (item) => {
    ...
    // ✅ allow *only* 3-month durations
    const isValidThreeMonthsOnly =
      months === 3 && years === 0 && weeks === 0 && days === 0;

    if (!isValidThreeMonthsOnly) {
      toast.error('Only 3-month subscription durations are allowed.');
      return;
    }
...
export default SubscriptionDurationThreeMonthSelector;
