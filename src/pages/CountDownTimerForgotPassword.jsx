...
const CountDownTimerForgotPassword = ({ onExpire, email }) => {
...
const sendOtp = async () => {
    try {
      const res = await resendForgotPasswordOtp({'email':email}); // ✅ call context method
...
export default CountDownTimerForgotPassword;
