...
const CashPayment = () => {
    ...
    useEffect(() => {
     ...
     const [search, setSearch] = useState('');
        ...
        const filteredUsers = cashpaymentdata.filter(user =>
            ...
            <div className="modal-body">
              ...
              <div className="row mb-4">
                ...
                <div className="col-md-8">
                  ...
                  <p className="mb-1"><strong>Fees Type:</strong> {paymentItem?.fees_type_display || "N/A"}</p>
                  <p className="mb-1"><strong>Recieved By:</strong> {paymentItem?.recieved_by || "N/A"}</p>
...
const AddModalPayment = () => {
  ...
  return (
    ...
    {AddModalPayment()}
    <Body>
        <HeaderTitle  page={'e-Cash Payment'} title={'Payment'}/>
                ...
                <div className="col-sm-12 mb-5 mt-5">
                  <div className="card shadow-sm rounded-4 border-0">
                    <div className="card-header bg-primary text-white">
                      <h5 className="mb-0">e-Cash Payment Receipts</h5>
                    </div>
