...
useEffect(() => {
  const fetchData = async () => {
    try {
      ...
      await getAllUserCategoryData();
      await getAllCountryData();
      await getListBanksCurrency();
      await getListBanksType();
      await getListAllBanks("NGN");
...
<ContainerTitle title={'Create User'}>
            ...
            <div className="container-fluid">
              <div className="col-sm-12 p-md-0">
                <div className="text-black text-center mb-5">
                  <h4>New Student, Intending and Existing student are expected to create an account</h4>
                </div>
              </div>
